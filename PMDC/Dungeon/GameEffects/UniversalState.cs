...
namespace PMDC.Dungeon
{
    ...
    /// <summary>
    /// Controls how much health is naturally recovered by characters every turn.
    /// </summary>
    [Serializable]
    public class NaturalRegenerationRateState : UniversalState
    {
        /// <summary>
        ...
        /// </summary>
        public int StarvingDamagePercentage;

        /// <summary>
        /// The flat amount of HP recovered by characters every turn when out of battle. 1000 means 1 HP. Negative values drain HP instead.
        /// </summary>
        public int FlatHealthRegeneration;
        /// <summary>
        /// The flat amount of HP recovered by characters every turn during battle. 1000 means 1 HP. Negative values drain HP instead.
        /// </summary>
        public int FlatHealthRegenerationInBattle;
        /// <summary>
        /// The flat amount of HP recovered by characters every turn while at 0 belly. 1000 means 1 HP. Negative values drain HP instead. 
        /// </summary>
        public int FlatStarvingDamage;

        public NaturalRegenerationRateState() : this(0, 0, 0, 0, 0, 0) { }

        public NaturalRegenerationRateState(int percent, int percent_battle, int percent_starve, int flat, int flat_battle, int flat_starve)
        {
            HealthPercentRegeneration = percent;
            HealthPercentRegenerationInBattle = percent_battle;
            StarvingDamagePercentage = percent_starve;
            FlatHealthRegeneration = flat;
            FlatHealthRegenerationInBattle = flat_battle;
            FlatStarvingDamage = flat_starve;
        }

        protected NaturalRegenerationRateState(NaturalRegenerationRateState other)
        {
            HealthPercentRegeneration = other.HealthPercentRegeneration;
            HealthPercentRegenerationInBattle = other.HealthPercentRegenerationInBattle;
            StarvingDamagePercentage = other.StarvingDamagePercentage;
            FlatHealthRegeneration = other.FlatHealthRegeneration;
            FlatHealthRegenerationInBattle = other.FlatHealthRegenerationInBattle;
            FlatStarvingDamage = other.FlatStarvingDamage;
        }

        public override GameplayState Clone() { return new NaturalRegenerationRateState(this); }
    }

    /// <summary>
    /// Controls how much hunger is naturally consumed by characters every turn.
    /// </summary>
    [Serializable]
    public class HungerConsumptionRateState : UniversalState
    {
        /// <summary>
        /// The maximum amount of hunger all characters start with when entering a new dungeon.
        /// </summary>
        public int MaxHunger;
        /// <summary>
        /// The amount of hunger consumed by the leader every turn. 1000 means 1 belly point.
        /// </summary>
        public int LeaderHungerConsumptionRate;
        /// <summary>
        /// The amount of hunger consumed by non-leader party members every turn. 1000 means 1 belly point.
        /// </summary>
        public int PartyHungerConsumptionRate;
        /// <summary>
        /// The amount of hunger consumed by guest party members every turn. 1000 means 1 belly point.
        /// </summary>
        public int GuestsHungerConsumptionRate;
        /// <summary>
        /// The amount of hunger consumed by enemies every turn. 1000 means 1 belly point.
        /// </summary>
        public int EnemyHungerConsumptionRate;
        /// <summary>
        /// The amount of hunger consumed by ally characters every turn. 1000 means 1 belly point.
        /// </summary>
        public int AllyHungerConsumptionRate;

        public HungerConsumptionRateState() : this(100, 0, 0, 0, 0, 0) { }

        public HungerConsumptionRateState(int max, int leader, int party, int guests, int enemy, int ally)
        {
            MaxHunger = max;
            LeaderHungerConsumptionRate = leader;
            PartyHungerConsumptionRate = party;
            GuestsHungerConsumptionRate = guests;
            EnemyHungerConsumptionRate = enemy;
            AllyHungerConsumptionRate = ally;
        }

        protected HungerConsumptionRateState(HungerConsumptionRateState other)
        {
            MaxHunger = other.MaxHunger;
            LeaderHungerConsumptionRate = other.LeaderHungerConsumptionRate;
            PartyHungerConsumptionRate = other.PartyHungerConsumptionRate;
            GuestsHungerConsumptionRate = other.GuestsHungerConsumptionRate;
            EnemyHungerConsumptionRate = other.EnemyHungerConsumptionRate;
            AllyHungerConsumptionRate = other.AllyHungerConsumptionRate;
        }

        public override GameplayState Clone() { return new HungerConsumptionRateState(this); }
    }
}
