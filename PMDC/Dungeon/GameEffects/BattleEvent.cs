...
namespace PMDC.Dungeon
{
    ...
    public abstract class BaseRecruitmentEvent : BattleEvent
    {
        ...
        public static IEnumerator<YieldInstruction> DungeonRecruit(GameEventOwner owner, Character ownerChar, Character targetChar, BattleScriptEvent actionScript)
        {
            ...
            if (DataManager.Instance.CurrentReplay == null)
            {
                yield return CoroutineManager.Instance.StartCoroutine(MenuManager.Instance.ProcessMenuCoroutine(new MemberFeaturesMenu(DataManager.Instance.Save.ActiveTeam, DungeonScene.Instance.ActiveTeam.Players.Count - 1, false, false, false)));
