...
namespace PMDC.Dungeon
{
     ...
     */
     [Serializable]
    public class SpawnRandomItemsBattleEvent : BattleEvent
    {
         ...
         */
        public int MaxRangeHeight;
        public SpawnRandomItemsBattleEvent() { Items = new SpawnList<MapItem>();  }
        
        public SpawnRandomItemsBattleEvent(SpawnList<MapItem> items, int minAmount, int maxAmount, int maxRangeWidth, int maxRangeHeight) : this()
        {
            Items = items;
            MinAmount = minAmount;
            MaxAmount = maxAmount;
        ...
        protected SpawnRandomItemsBattleEvent(SpawnRandomItemsBattleEvent other) : this()
        {
            Items = other.Items;
        ...
        public override GameEvent Clone() { return new SpawnRandomItemsBattleEvent(this); }
     ...
     */
     [Serializable]
    public class SpawnRandomEnemiesBattleEvent : BattleEvent
    {
         ...
         */
        public int MaxRangeHeight;
        public SpawnRandomEnemiesBattleEvent() { Enemies = new SpawnList<MobSpawn>(); }
        public SpawnRandomEnemiesBattleEvent(SpawnList<MobSpawn> enemies, int minAmount, int maxAmount, int maxRangeWidth, int maxRangeHeight) : this()
        {
            Enemies = enemies;
            MinAmount = minAmount;
            MaxAmount = maxAmount;
        ...
        protected SpawnRandomEnemiesBattleEvent(SpawnRandomEnemiesBattleEvent other) : this()
        {
        ...
        public override GameEvent Clone() { return new SpawnRandomEnemiesBattleEvent(this); }
